...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert review without manually setting status — DB default will be 'approved'
    $stmt = $conn->prepare("INSERT INTO reviews (name, rating, comment, item_type, item_id) VALUES (?, ?, ?, ?, ?)");
