...
<body>
<h2 style="text-align:center;">All Attractions</h2>
 <!-- Go Back Arrow -->
    ...
    <tr>
        ...
        <td>
            <?php if (!empty($row['image_url'])): ?>
                <img src="<?= htmlspecialchars($row['image_url']) ?>" alt="Attraction Image">
            <?php else: ?>
                <span>No image</span>
            <?php endif; ?>
        </td>
        ...
        <td>
            <a class="btn" href="edit_attractions.php?id=<?= $row['id'] ?>">Edit</a>
            <a class="btn btn-red" href="delete_attractions.php?id=<?= $row['id'] ?>" onclick="return confirm('Delete this attraction?')">Delete</a>
        </td>
    </tr>
    <?php endwhile; ?>
</table>
